...
int Config::CREATURE_ANTENNA_Y_OFFSET;
int Config::CREATURE_ANTENNA_X_OFFSET;
...
void Config::readConfig(std::string& path)
{
    ...
    CREATURE_ANTENNA_Y_OFFSET = data["creature"]["antennaYOffset"];
    CREATURE_ANTENNA_X_OFFSET = data["creature"]["antennaXOffset"];
